...
exports.GameLobby = function(name) {
	...
	this.template = ".gamelobby>#title{"+this.name+"}+#player_list+#game+#buttons>button#delete{delete this game}+button#join{join this game}+button#start{start this game}";
